...
class CategoryController extends Controller
{
    ...
    public function removeImage(Request $req) 
    {
        ...
        else 
        {
            ...
            $filename = Category::where(['category_id' => $req['category_id']])->first()->image;
            $data = Category::where(['category_id' => $req['category_id']])->update($payload);

            if ($data)
            {
                unlink(public_path('contents/categories/thumbnails/'.$filename));
				unlink(public_path('contents/categories/covers/'.$filename));
    ...
    public function uploadImage(Request $req) 
    {
        ...
        else 
        {
			...
			$destination = public_path('contents/categories/thumbnails/'.$filename);
			...
			$destination = public_path('contents/categories/covers/');
